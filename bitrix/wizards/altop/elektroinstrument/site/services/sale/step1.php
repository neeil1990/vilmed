...
COption::SetOptionString("elektroinstrument", "shopLocalization", $shopLocalization, "ru", WIZARD_SITE_ID);
...
if($bRus || COption::GetOptionString("elektroinstrument", "wizard_installed", "N", WIZARD_SITE_ID) != "Y" || WIZARD_INSTALL_DEMO_DATA) {
	...
	if($shopLocalization == "ru") {
		...
		COption::SetOptionString("elektroinstrument", "shopLocation_ua", $shopLocation, false, WIZARD_SITE_ID);
		$shopOfName = $wizard->GetVar("shopOfName_ua");
		COption::SetOptionString("elektroinstrument", "shopOfName_ua", $shopOfName, false, WIZARD_SITE_ID);
		$shopAdr = $wizard->GetVar("shopAdr_ua");
		COption::SetOptionString("elektroinstrument", "shopAdr_ua", $shopAdr, false, WIZARD_SITE_ID);

		$shopEGRPU_ua = $wizard->GetVar("shopEGRPU_ua");
		COption::SetOptionString("elektroinstrument", "shopEGRPU_ua", $shopEGRPU_ua, false, WIZARD_SITE_ID);
		$shopINN_ua = $wizard->GetVar("shopINN_ua");
		COption::SetOptionString("elektroinstrument", "shopINN_ua", $shopINN_ua, false, WIZARD_SITE_ID);
		$shopNDS_ua = $wizard->GetVar("shopNDS_ua");
		COption::SetOptionString("elektroinstrument", "shopNDS_ua", $shopNDS_ua, false, WIZARD_SITE_ID);
		$shopNS_ua = $wizard->GetVar("shopNS_ua");
		COption::SetOptionString("elektroinstrument", "shopNS_ua", $shopNS_ua, false, WIZARD_SITE_ID);
		$shopBank_ua = $wizard->GetVar("shopBank_ua");
		COption::SetOptionString("elektroinstrument", "shopBank_ua", $shopBank_ua, false, WIZARD_SITE_ID);
		$shopMFO_ua = $wizard->GetVar("shopMFO_ua");
		COption::SetOptionString("elektroinstrument", "shopMFO_ua", $shopMFO_ua, false, WIZARD_SITE_ID);
		$shopPlace_ua = $wizard->GetVar("shopPlace_ua");
		COption::SetOptionString("elektroinstrument", "shopPlace_ua", $shopPlace_ua, false, WIZARD_SITE_ID);
		$shopFIO_ua = $wizard->GetVar("shopFIO_ua");
		COption::SetOptionString("elektroinstrument", "shopFIO_ua", $shopFIO_ua, false, WIZARD_SITE_ID);
		$shopTax_ua = $wizard->GetVar("shopTax_ua");
		COption::SetOptionString("elektroinstrument", "shopTax_ua", $shopTax_ua, false, WIZARD_SITE_ID);
	}
	...
	if($shopLocalization == "ua") {
		...
		COption::SetOptionString("elektroinstrument", "personTypeFizUa", $personTypeFizUa, false, WIZARD_SITE_ID);
	...
	$arPaySystems = array();
	if($paysystem["cash"] == "Y") {
		$logo = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH ."/images/paysystem/cash.jpg";
	...
	if($personType["fiz"] == "Y" && $shopLocalization != "ua") {
		if($bRus) {
			...
			$logo = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH ."/images/paysystem/yandex_cards.jpg";
			$arPicture = CFile::MakeFileArray($logo);
			$arPaySystems[] = array(
				"PAYSYSTEM" => array(
			...
			$logo = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH ."/images/paysystem/yandex_terminals.jpg";
			$arPicture = CFile::MakeFileArray($logo);
			$arPaySystems[] = array(
				"PAYSYSTEM" => array(
			...
			if($paysystem["sber"] == "Y") {
				$logo = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH ."/images/paysystem/sberbank.jpg";
				$arPicture = CFile::MakeFileArray($logo);
				$arPaySystems[] = array(
					"PAYSYSTEM" => array(
	...
	if(COption::GetOptionString("elektroinstrument", "wizard_installed", "N", WIZARD_SITE_ID) != "Y" || WIZARD_INSTALL_DEMO_DATA) {
		...
		function __MakeOrder($prdCnt = 1, $arData = Array()) {
			...
			$arPrd = Array();
			$dbItem = CIBlockElement::GetList(Array(), Array("IBLOCK_TYPE" => "catalog", "IBLOCK_SITE_ID" => WIZARD_SITE_ID, "PROPERTY_NEWPRODUCT" => false), false, Array("nTopCount" => 100), Array("ID", "IBLOCK_ID", "XML_ID", "NAME", "DETAIL_PAGE_URL", "IBLOCK_XML_ID"));
