...
$MESS["SOA_ORDER_SUC1"] = "
Все ваши заказы Вы можете посмотреть в <a href=\"#LINK#\">Персональном разделе сайта</a>. 
<br>
После проверки заказа и уточнений по срокам поставки, менеджер направит Вам счет на e-mail.
<br>
Если потребуется уточнения, менеджер также отпишется Вам на e-mail.
<br><br>
