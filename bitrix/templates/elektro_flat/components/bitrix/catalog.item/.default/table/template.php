...
<div class="catalog-item-info">
	...
	if($inArticle || $inRating) {?>
		<div class="article_rating">
			...
			if($inArticle) {?>
				<div class="article">
					<?=Loc::getMessage("CT_BCS_ELEMENT_ARTNUMBER")?><?=!empty($arElement["PROPERTIES"]["ARTNUMBER"]["VALUE"]) ? $arElement["PROPERTIES"]["ARTNUMBER"]["VALUE"] : $arElement["PROPERTIES"]["CML2_ARTICLE"]["VALUE"];?>
				</div>
			<?}
			//RATING//
			if($inRating) {?>
