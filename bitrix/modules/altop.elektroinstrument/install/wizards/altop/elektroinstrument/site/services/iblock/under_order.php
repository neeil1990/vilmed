...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/under_order.xml";
$iblockCode = "under_order_".WIZARD_SITE_ID;
$iblockType = "forms";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/form_under_order.php", array("UNDER_ORDER_IBLOCK_ID" => $iblockID));?>