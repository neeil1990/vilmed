...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/news_bottom.php", array("NEWS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/news_left.php", array("NEWS_IBLOCK_ID" => $iblockID));
