...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/contact_form.xml";
$iblockCode = "contact_".WIZARD_SITE_ID;
$iblockType = "forms";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/form_contact.php", array("CONTACT_IBLOCK_ID" => $iblockID));?>