...
$iblockCode = "promotions_".WIZARD_SITE_ID;
$iblockType = "content";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/promotions.php", array("PROMOTIONS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/promotions/index.php", array("PROMOTIONS_IBLOCK_ID" => $iblockID));?>